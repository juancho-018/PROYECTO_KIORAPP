      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-1.5">Idioma del Sistema</label>
              <select 
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4 md:col-span-2">
           <div className="flex items-center justify-between border-b border-slate-50 pb-4">
             <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
               <svg className="w-5 h-5 text-sky-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
               Seguridad de la Cuenta
             </h3>
           </div>
           <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-2">
             <div>
               <p className="text-sm font-bold text-gray-800">Cambiar Contraseña de Acceso</p>
               <p className="text-xs text-gray-500 font-medium">Se recomienda actualizar su contraseña periódicamente para mantener la seguridad.</p>
             </div>
             <button 
               onClick={() => {
                 window.dispatchEvent(new CustomEvent('kiora-open-profile'));
               }}
               className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-2.5 rounded-xl font-bold text-xs transition-all flex items-center gap-2 shrink-0"
             >
