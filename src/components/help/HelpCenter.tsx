...
export default function HelpCenter({ hideBackButton = false }: { hideBackButton?: boolean }) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 pb-24 relative">
      ...
      <button
        type="button"
        className="fixed bottom-24 right-6 bg-[#ec131e] hover:bg-[#d01019] text-white px-6 py-3.5 rounded-full shadow-2xl flex items-center gap-3 active:scale-95 transition-all z-50 mb-4"
      >
